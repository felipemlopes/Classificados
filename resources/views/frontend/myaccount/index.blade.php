        ...
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 box box-minhaconta">
                ...
                <div class="col-sm-12 col-md-12 col-lg-12 secao-minhaconta">
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-sm-5 col-md-4 col-lg-4 col-sm-offset-1 col-md-offset-2 col-lg-offset-2">
                            <div class="small-box">
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-sm-5 col-md-4 col-lg-4 col-sm-offset-3 col-md-offset-4 col-lg-offset-4">
                            <div class="small-box">
                                <div class="inner text-center">
                                    <h3>{{$messages}}</h3>
